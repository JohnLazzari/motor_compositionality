...
from analysis.FixedPointFinderBase import FixedPointFinderBase
from analysis.FixedPoints import FixedPoints
...
class FixedPointFinderTorch(FixedPointFinderBase):
    ...
    def _run_joint_optimization(self, initial_states, inputs, cond_ids=None):
        ...
        x_1xbxd = torch.from_numpy(initial_states)
        ...
        while True:
            ...
            F_x_bx1xd, F_x_1xbxd = self.rnn(inputs_bx1xd, x_1xbxd, x_1xbxd, noise=False)
